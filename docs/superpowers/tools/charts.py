...
SPECS = [
 ...
 dict(page='guides/electric-boiler-vs-heat-pump/index.html', table=0, fid='chart-electric-vs-heat-pump', form='grouped', cat=0, cols=[(1, 'Electric boiler'), (2, 'Heat pump, standard tariff'), (3, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost: electric boiler versus heat pump', caption='Electric boiler at 100% efficiency and a heat pump with COP 2.9, both at 26.32p/kWh, or 18p/kWh on a heat pump tariff. Heat demand from 6,300 kWh (2-bed terrace) to 13,140 kWh (4-bed detached), from the shared model in js/heat-model.js.'),
 ...
 dict(page='guides/heat-pump-cost-4-bed-house/index.html', table=5, fid='chart-4bed-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 4-bed detached, 13,140 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar; oil and LPG use September 2026 market prices.'),
 ...
 dict(page='guides/heat-pump-cost-3-bed-semi/index.html', table=4, fid='chart-3bed-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed semi, 9,900 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar; oil and LPG use September 2026 market prices.'),
 ...
 dict(page='guides/heat-pump-cost-end-terrace/index.html', table=1, fid='chart-endterrace-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Total out of pocket',
      title='Where the money goes on an end terrace installation', caption='Cost ranges for each element after the £7,500 grant is deducted from the heat pump line. The total is what a typical home of this type pays out of pocket.'),
 ...
 dict(page='guides/heat-pump-1960s-house/index.html', table=1, fid='chart-1960s-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Total out of pocket',
      title='Where the money goes on a 1960s house installation', caption='Cost ranges for each element after the £7,500 grant is deducted from the heat pump line. The total is what a typical home of this type pays out of pocket.'),
 ...
 dict(page='guides/heat-pump-cost-2-bed-bungalow/index.html', table=1, fid='chart-2bedbungalow-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Total out of pocket',
      title='Where the money goes on a 2-bed bungalow installation', caption='Cost ranges for each element after the £7,500 grant is deducted from the heat pump line. The total is what a typical home of this type pays out of pocket.'),
 dict(page='guides/heat-pump-cost-2-bed-bungalow/index.html', table=4, fid='chart-2bedbungalow-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 2-bed bungalow, 8,280 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 ...
 dict(page='guides/heat-pump-cost-3-bed-detached/index.html', table=4, fid='chart-3beddetached-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed detached, 10,530 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 ...
 dict(page='guides/heat-pump-cost-bungalow/index.html', table=4, fid='chart-bungalow-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, bungalow, 10,350 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil and LPG at September 2026 market prices.'),
 ...
 dict(page='guides/solar-panel-payback-uk/index.html', table=0, fid='chart-solar-payback', form='hbars', cat=0, cols=[(3, 'Payback')], unit='yr',
      title='Solar payback period by scenario', caption='System cost divided by annual benefit (bill savings plus export income) at 26.32p/kWh electricity and 12p/kWh export. Larger systems and southern roofs pay back fastest.'),
 ...
 dict(page='guides/best-heat-pump-tariffs/index.html', table=1, fid='chart-tariff-costs', form='hbars', cat=0, cols=[(1, 'Annual heating cost')], unit='£', highlight_label='Standard variable (26.32p flat)',
      title='Annual heating cost by tariff, 3-bed semi', caption='9,900 kWh heat demand, COP 2.9, 60% of heating shifted to off-peak windows where the tariff has them. The standard variable rate is the gold bar for comparison.'),
 dict(page='guides/boiler-upgrade-scheme-guide/index.html', table=2, fid='chart-bus-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff, ~18p/kWh)',
      title='Annual heating cost after switching, 3-bed semi', caption='9,790 kWh heat demand at the Ofgem cap for October to December 2026.'),
 dict(page='guides/heat-pump-old-house/index.html', table=2, fid='chart-old-house-running', form='hbars', cat=0, cols=[(1, 'Annual heating cost')], unit='£', highlight_label='Heat pump (COP 2.9, heat pump tariff)',
      title='Annual heating cost in an insulated old house, 7,497 kWh', caption='Ofgem cap for October to December 2026. The heat pump tariff bar shows the 17p to 20p effective-rate range.'),
