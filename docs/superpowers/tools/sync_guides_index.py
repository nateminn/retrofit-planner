...
NEW = {
    ...
    'epc-rating-by-house-age': ('epc', 'EPC Rating by House Age', 'how-epc-points-are-calculated', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-victorian-house': ('epc', 'EPC Rating for a Victorian House', 'how-to-improve-epc-rating', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-1930s-house': ('epc', 'EPC Rating for a 1930s House', 'epc-rating-landlords', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-1950s-house': ('epc', 'EPC Rating for a 1950s House', 'epc-cost', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-1970s-house': ('epc', 'EPC Rating for a 1970s House', 'how-epc-points-are-calculated', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-1980s-1990s-house': ('epc', 'EPC Rating for a 1980s or 1990s House', 'how-to-improve-epc-rating', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'epc-rating-new-build-house': ('epc', 'EPC Rating for a New Build House', 'epc-rating-landlords', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge landlord">For landlords</span><span class="gi-badge new">New</span>'),
    'energy-use-by-council': ('bills', 'Energy Use by Council', 'average-energy-bills-uk', '<span class="gi-badge homeowner">For homeowners</span><span class="gi-badge new">New</span>'),
