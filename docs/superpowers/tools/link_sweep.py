...
PLAN_NEW = {
    ...
    'heat-pump-cost-5-bed-house': ('5-Bed House Costs', 'Large homes and cascades', 'house', ['heat-pump-cost-by-house-type', 'heat-pump-cost-4-bed-house', '_heat-pump-calculator', 'radiator-sizing-heat-pump']),
