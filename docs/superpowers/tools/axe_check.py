...
CALC = {'heat-pump-calculator/', 'energy-bill-calculator/', 'landlord-epc-calculator/', 'heat-pump-running-cost-calculator/', 'retrofit-plan/', 'boiler-vs-heat-pump/', 'solar-calculator/', 'insulation-calculator/', 'epc-calculator/', 'grants/'}
out = []
