...
SPECS = [
 ...
 dict(page='guides/heat-pump-running-costs/index.html', table=0, fid='chart-running-costs-by-property', form='grouped', cat=0, cols=[(2, 'Gas boiler'), (3, 'Heat pump, standard tariff'), (4, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost by property type', caption='Gas boiler at 90% efficiency; heat pump at the measured median efficiency of 2.78 (2.55 on the two old rows); Ofgem cap for October to December 2026. The heat pump tariff column uses 19.8p per kWh, Cosy Octopus with most heating in the cheap hours.'),
 dict(page='guides/heat-pump-running-costs/index.html', table=1, fid='chart-cost-per-kwh-by-cop', form='grouped', cat=0, cols=[(1, 'Standard tariff'), (2, 'Heat pump tariff')], unit='p', label=1,
      title='Cost per kWh of heat at each efficiency level', caption='Pence per kWh of delivered heat at 26.32p/kWh on a standard tariff and 19.8p/kWh on a heat pump tariff, at the efficiencies our model uses: the Electrification of Heat trial quartiles and median, and 3.25 for excellent fabric. Gas at 90% boiler efficiency costs 8.9p per kWh for comparison.'),
 dict(page='guides/heat-pump-running-costs/index.html', table=2, fid='chart-cost-per-kwh-by-fuel', form='hbars', cat=0, cols=[(2, 'Cost per kWh of heat')], unit='p', highlight_last=True,
      title='Cost per kWh of heat by fuel', caption='Fuel price divided by system efficiency. Heat pump rows use the measured median efficiency of 2.78; oil and LPG boilers 85%, gas 90%. Ofgem cap for October to December 2026; heating oil at 11.3p per kWh, the BoilerJuice UK average on 25 September 2026, and LPG at 9.5p.'),
 dict(page='guides/heat-pump-vs-new-boiler/index.html', table=0, fid='chart-15-year-total', form='row_hbars', row='15-year total cost', cats=['New gas boiler', 'Heat pump, standard tariff', 'Heat pump, heat pump tariff'], cols=[1, 2, 3], unit='£', highlight=2,
      title='15-year total cost of ownership, 3-bed semi', caption='Upfront cost after the £7,500 grant, running costs and £100 a year of servicing over 15 years. The heat pump ranges reflect the spread of installed costs for a heat pump of this size; the boiler is the DESNZ average of about £3,500.'),
 dict(page='guides/heat-pump-vs-new-boiler/index.html', table=1, fid='chart-running-cost-comparison', form='grouped', cat=0, cols=[(1, 'Gas boiler'), (2, 'Heat pump, standard tariff'), (3, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost by property type', caption='Ofgem cap for October to December 2026, gas at 90% boiler efficiency, heat pump at the measured median efficiency of 2.78 on a standard tariff or a 19.8p heat pump tariff.'),
 dict(page='guides/electric-boiler-vs-heat-pump/index.html', table=0, fid='chart-electric-vs-heat-pump', form='grouped', cat=0, cols=[(1, 'Electric boiler'), (2, 'Heat pump, standard tariff'), (3, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost: electric boiler versus heat pump', caption='Electric boiler at 100% efficiency and a heat pump at the measured median efficiency of 2.78, both at 26.32p/kWh, or 19.8p/kWh on a heat pump tariff. Heat demand from 6,300 kWh (2-bed terrace) to 13,140 kWh (4-bed detached), from the shared model behind our calculators.'),
 dict(page='guides/storage-heaters-vs-heat-pump/index.html', table=0, fid='chart-storage-vs-heat-pump', form='grouped', cat=0, cols=[(1, 'Storage heaters'), (2, 'Heat pump, standard tariff'), (3, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost: storage heaters versus heat pump', caption='Storage heaters on Economy 7, 80% overnight charge and 20% daytime top-up; heat pump at the measured median efficiency of 2.78 at the Ofgem cap for October to December 2026, standard or heat pump tariff.'),
 dict(page='guides/heat-pump-cost-by-house-type/index.html', table=0, fid='chart-installed-cost-by-type', form='hbars', cat=0, cols=[(2, 'Installed cost')], unit='£',
      title='Installed cost before the grant, by property type', caption='Middle half of Boiler Upgrade Scheme installations for a heat pump of the size each home needs, including the heat pump, cylinder, labour and VAT. Deduct £7,500, or £9,000 until 31 March 2027 for homes heated by oil or LPG with no mains gas connection.'),
 dict(page='guides/heat-pump-cost-by-house-type/index.html', table=5, fid='chart-running-cost-by-type', form='grouped', cat=0, cols=[(1, 'Gas boiler'), (2, 'Heat pump, standard tariff'), (3, 'Heat pump, heat pump tariff')], unit='£', label=2,
      title='Annual heating cost by house type', caption='Gas at 7.97p/kWh and 90% boiler efficiency; heat pump seasonal efficiency 2.78, the measured median, at 26.32p/kWh or 19.8p/kWh effective on a heat pump tariff. Average insulation.'),
 dict(page='guides/heat-pump-cost-4-bed-house/index.html', table=1, fid='chart-4bed-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 4-bed detached heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-4-bed-house/index.html', table=5, fid='chart-4bed-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 4-bed detached, 13,140 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil at 11.3p per kWh, the BoilerJuice UK average on 25 September 2026, and LPG at the 9.5p per kWh our model uses.'),
 dict(page='guides/heat-pump-cost-3-bed-semi/index.html', table=1, fid='chart-3bed-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 3-bed semi heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-3-bed-semi/index.html', table=4, fid='chart-3bed-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed semi, 9,900 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil at 11.3p per kWh, the BoilerJuice UK average on 25 September 2026, and LPG at the 9.5p per kWh our model uses.'),
 dict(page='guides/heat-pump-cost-2-bed-terrace/index.html', table=1, fid='chart-2bedterrace-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 2-bed terrace heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-2-bed-terrace/index.html', table=4, fid='chart-2bedterrace-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 2-bed terrace, 6,300 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 dict(page='guides/heat-pump-cost-end-terrace/index.html', table=1, fid='chart-endterrace-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What an end terrace installation costs, with a new boiler for comparison', caption='The middle half of real installations for a heat pump of each size, from DESNZ Boiler Upgrade Scheme statistics. The gold bar is what a typical 3-bed end terrace pays after the grant. The boiler bar is the DESNZ average of about £3,500 for a new gas boiler in a three bedroom home, including VAT.'),
 dict(page='guides/heat-pump-cost-end-terrace/index.html', table=4, fid='chart-endterrace-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed end terrace, 9,270 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 dict(page='guides/heat-pump-1960s-house/index.html', table=1, fid='chart-1960s-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 1960s house installation costs, before and after the grant', caption='The middle half of real installations for a heat pump of each size, from DESNZ Boiler Upgrade Scheme statistics. The gold bar is what a typical 1960s semi pays after the grant. The boiler bar is the DESNZ average of about £3,500 for a new gas boiler in a three bedroom home, including VAT.'),
 dict(page='guides/heat-pump-1960s-house/index.html', table=4, fid='chart-1960s-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 1960s estate house, 9,900 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 dict(page='guides/heat-pump-cost-2-bed-bungalow/index.html', table=1, fid='chart-2bedbungalow-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 2-bed bungalow heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-2-bed-bungalow/index.html', table=4, fid='chart-2bedbungalow-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 2-bed bungalow, 8,280 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil at 11.3p per kWh, the BoilerJuice UK average on 25 September 2026, and LPG at the 9.5p per kWh our model uses.'),
 dict(page='guides/heat-pump-cost-3-bed-detached/index.html', table=1, fid='chart-3beddetached-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 3-bed detached heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-3-bed-detached/index.html', table=4, fid='chart-3beddetached-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed detached, 10,530 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil at 11.3p per kWh, the BoilerJuice UK average on 25 September 2026.'),
 dict(page='guides/heat-pump-cost-5-bed-house/index.html', table=1, fid='chart-5bed-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a 5-bed heat pump costs, before and after the grant', caption='The whole typical job as recorded under the Boiler Upgrade Scheme, before and after the grant. Radiator upgrades can add to it where they are needed and not already in the quote.'),
 dict(page='guides/heat-pump-cost-5-bed-house/index.html', table=4, fid='chart-5bed-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 5-bed house, 17,550 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 dict(page='guides/heat-pump-cost-bungalow/index.html', table=1, fid='chart-bungalow-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a bungalow installation costs, before and after the grant', caption='The middle half of real installations for a heat pump of each size, from DESNZ Boiler Upgrade Scheme statistics. The gold bar is what a typical three bedroom bungalow pays after the standard grant. The £9,000 rate is for homes heated by oil or LPG with no mains gas, until March 2027.'),
 dict(page='guides/heat-pump-cost-bungalow/index.html', table=4, fid='chart-bungalow-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, bungalow, 10,350 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Oil at 11.3p and LPG at 9.5p per kWh.'),
 dict(page='guides/heat-pump-victorian-terrace/index.html', table=1, fid='chart-victorian-breakdown', form='hbars', cat=0, cols=[(1, 'Range')], unit='£', drop=['BUS grant', 'Net heat pump cost'], highlight_label='Heat pump (heat pump tariff)',
      title='What a Victorian terrace installation costs, before and after the grant', caption='The middle half of real installations for a heat pump of each size, from DESNZ Boiler Upgrade Scheme statistics. The gold bar is what the worked example in this guide pays after the grant. The boiler bar is the DESNZ average of about £3,500 for a new gas boiler in a three bedroom home, including VAT.'),
 dict(page='guides/heat-pump-victorian-terrace/index.html', table=4, fid='chart-victorian-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, Victorian terrace, 9,790 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar.'),
 dict(page='guides/average-energy-bills-uk/index.html', table=0, fid='chart-bills-by-property', form='stacked', cat=0, cols=[(1, 'Gas'), (2, 'Electricity')], unit='£',
      title='Annual energy bill by property type', caption='Gas and electricity at the Ofgem cap for October to December 2026, including standing charges. Gas consumption from our heat demand model fitted to DESNZ National Energy Efficiency Data-Framework data; electricity is the 2024 median for homes with that many bedrooms, from the same data.'),
 dict(page='guides/energy-bills-by-household-size/index.html', table=0, fid='chart-bills-by-occupants', form='stacked', cat=0, cols=[(1, 'Gas'), (2, 'Electricity')], unit='£',
      title='Annual energy bill by number of adults', caption='Median metered use by number of adults (DESNZ NEED, 2024) at the Ofgem cap for October to December 2026, dual fuel, direct debit. Heating costs are largely fixed by the property, so the cost per adult falls as households grow.'),
 dict(page='guides/solar-panel-payback-uk/index.html', table=0, fid='chart-solar-payback', form='hbars', cat=0, cols=[(3, 'Payback')], unit='yr',
      title='Solar payback period by scenario', caption='System cost divided by the first year\'s benefit (bill savings plus export income) at 26.32p per kWh electricity and 12p per kWh export. The battery bar counts one replacement battery. Southern England and south facing roofs pay back fastest.'),
 dict(page='guides/are-solar-panels-worth-it-uk/index.html', table=1, fid='chart-solar-benefit', form='stacked', cat=0, cols=[(2, 'Bill saving'), (3, 'Export income')], unit='£',
      title='Annual benefit from solar panels by system', caption='Bill savings from self-used electricity at 26.32p/kWh plus Smart Export Guarantee income at 12p/kWh. Self-use comes from the MCS look-up tables: about 19% on a 4 kW array, rising to 52% with a 5 kWh battery.'),
 dict(page='guides/best-heat-pump-tariffs/index.html', table=1, fid='chart-tariff-costs', form='hbars', cat=0, cols=[(1, 'Annual heating cost')], unit='£', highlight_label='Standard variable (26.32p flat)',
      title='Annual heating cost by tariff, 3-bed semi', caption='9,900 kWh heat demand, heat pump at the measured median efficiency of 2.78, with the share of heating in cheap windows scaled by their length. The standard variable rate is the gold bar for comparison.'),
 dict(page='guides/boiler-upgrade-scheme-guide/index.html', table=2, fid='chart-bus-running', form='hbars', cat=0, cols=[(1, 'Annual cost')], unit='£', highlight_label='Heat pump (heat pump tariff, 19.8p/kWh)',
      title='Annual heating cost after switching, 3-bed semi', caption='9,900 kWh heat demand at the Ofgem cap for October to December 2026. Heat pump at the measured median efficiency of 2.78.'),
 dict(page='guides/heat-pump-old-house/index.html', table=2, fid='chart-old-house-running', form='hbars', cat=0, cols=[(1, 'Annual heating cost')], unit='£', highlight_label='Heat pump (heat pump tariff)',
      title='Annual heating cost, 3-bed Edwardian semi, 9,900 kWh', caption='Ofgem cap for October to December 2026. The heat pump on a heat pump tariff is the gold bar. Heat pump seasonal efficiency 2.78, the median measured in the Electrification of Heat trial.'),
 dict(page='guides/solar-battery-storage-uk/index.html', table=0, fid='chart-battery-savings', form='hbars', cat=0, cols=[(3, 'Annual saving')], unit='£',
      title='Extra benefit a year from a battery, 4 kW solar system', caption='Extra solar used at home, valued at 26.32p per kWh, minus the 12p per kWh it would have earned as export. The gain levels off above 5 kWh because there is rarely enough surplus to fill a bigger battery.'),
 dict(page='guides/heat-pump-flat/index.html', table=0, fid='chart-flat-costs', form='hbars', cat=0, cols=[(2, 'Install cost')], unit='£',
      title='Installed cost by flat size, before the grant', caption='The middle half of real installations for the 4.5 to 7 kW heat pump each needs, from DESNZ Boiler Upgrade Scheme statistics. After the £7,500 grant a typical flat pays £4,000 to £4,700.'),
]
